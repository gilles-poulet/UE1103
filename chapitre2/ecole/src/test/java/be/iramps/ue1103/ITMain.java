...
public class ITMain {
    ...
    public void happyPath (){
        ...
        assertEquals(3,systemeExploitation.getNbreInscrit(etudiant.getNom()));
        assertEquals(0.63f,systemeExploitation.getTauxMoyenParticipation(seancesSystemeExploitation,etudiant.getNom()),0.01f);
        assertEquals(java.time.LocalDate.of(2025,9,15),systemeExploitation.getDateDebutLabo(seancesSystemeExploitation,1f));        
        assertEquals(0.6f,systemeExploitation.getTauxAbsence(seancesSystemeExploitation, abernard));
        assertEquals(0.5f,systemeExploitation.getTauxAbsence(seancesSystemeExploitation, gmoreau));
        assertEquals(0.0f,systemeExploitation.getTauxAbsence(seancesSystemeExploitation, elambert));

        assertEquals(3,baseReseau.getNbreInscrit(etudiant.getNom()));
        assertEquals(0.46f,baseReseau.getTauxMoyenParticipation(seancesBaseReseau,etudiant.getNom()),0.01f);
        assertEquals(java.time.LocalDate.of(2025,9,29),baseReseau.getDateDebutLabo(seancesBaseReseau,0.6f));
        assertEquals(0.5f,baseReseau.getTauxAbsence(seancesBaseReseau, abernard));
        assertEquals(0.5f,baseReseau.getTauxAbsence(seancesBaseReseau, srodriguez));
        assertEquals(0.6f,baseReseau.getTauxAbsence(seancesBaseReseau, elambert));

        assertEquals(2,droitCommercial.getNbreInscrit(etudiant.getNom()));
        assertEquals(0.65f,droitCommercial.getTauxMoyenParticipation(seancesDroitCommercial,etudiant.getNom()));
        assertEquals(null,droitCommercial.getDateDebutLabo(seancesDroitCommercial,0.0f));
        assertEquals(0.3f,droitCommercial.getTauxAbsence(seancesDroitCommercial, pthomas));
        assertEquals(0.4f, droitCommercial.getTauxAbsence(seancesDroitCommercial, jmartin),0.001f);
        //#endregion
    }
}
